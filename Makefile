...
deploy-sepolia:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account $(ACCOUNT_NAME) --sender $(SENDER_ADDRESS) --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) 